...
Namespace NorthwindDemo.Win
	Partial Public Class NorthwindDemoWindowsFormsApplication
		...
		Private Sub InitializeComponent()
			...
			Me.module3 = New NorthwindDemo.Module.NorthwindDemoModule()
			...
			' sqlConnection1
			' 
			Me.sqlConnection1.ConnectionString = "Data Source=(local);Initial Catalog=NorthwindDemo;Integrated Security=SSPI;Pooling=false"
			Me.sqlConnection1.FireInfoMessageEventOnUserErrors = False
			' 
			' NorthwindDemoWindowsFormsApplication
			' 
			Me.ApplicationName = "NorthwindDemo"
...
'			Me.DatabaseVersionMismatch += New System.EventHandler(Of DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs)(Me.NorthwindDemoWindowsFormsApplication_DatabaseVersionMismatch);
		...
		Private module3 As NorthwindDemo.Module.NorthwindDemoModule
