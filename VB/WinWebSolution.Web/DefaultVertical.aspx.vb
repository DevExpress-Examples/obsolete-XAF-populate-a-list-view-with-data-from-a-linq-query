...
Partial Public Class DefaultVertical
	...
	Public ReadOnly Property DefaultContainer() As IActionContainer
		Get
			Return ToolBar.FindActionContainerById("View")
		End Get
	End Property

	Public Function GetContainers() As ICollection(Of IActionContainer)
	...
	Public Sub SetView(ByVal view As DevExpress.ExpressApp.View)
	...
	Public Sub SetStatus(ByVal statusMessages As System.Collections.Generic.ICollection(Of String))
	...
	Public Property IsSizeable() As Boolean
		...
		End Set
	End Property
	Public ReadOnly Property ViewSiteControl() As Object
		Get
			Return ViewSite
		End Get
	End Property
	Public Event ViewControlAdding As EventHandler
	#End Region
End Class
